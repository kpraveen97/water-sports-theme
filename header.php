...
$phone = $event_listing_theme_options['event-listing-water-sports-header-phone'];
$email = $event_listing_theme_options['event-listing-water-sports-header-email'];
$social = absint($event_listing_theme_options['event-listing-water-sports-header-social']);
$h_search = absint($event_listing_theme_options['event-listing-water-sports-header-search']);
?>
<!doctype html>
            ...
            <div class="header-main">
                ...
                <div class="container" id="site-navigation">
                    <div class="row align-middle">
                        ...
                        $nav_column_class = 'column column-12 column-t-9 order-t-2';
                        if ($h_search == 1) {
                            ?>
                        ...
                        <div class="<?php echo $nav_column_class; ?>">
                            ...
                            <nav class="main-navigation" <?php event_listing_do_microdata('navigation'); ?>>
                                ...
                                <button class="theme_btn">Book Today</button>
                            </nav><!-- #site-navigation -->
                        </div> <!-- .column -->
                    </div> <!-- .row -->
                </div> <!-- .container -->
