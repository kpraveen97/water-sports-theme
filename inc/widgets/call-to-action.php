...
if (!class_exists('Event_Listing_CTA')) :
    ...
    class Event_Listing_CTA extends WP_Widget
    {
        ...
        {
            $defaults = array(
                'title'    => esc_html__( 'Popular Music Event by Local Band', 'event-listing-water-sports' ),
                'sub_title'    => esc_html__( 'Do you want to register for free today? We will give 100 free ticket today. Signup now!', 'event-listing-water-sports' ),
                'cta_btn_text'    => esc_html__( 'Signup', 'event-listing-water-sports' ),
                'btn_link'    => esc_url( '#', 'event-listing-water-sports' ),
        ...
        {
            $opts = array(
                'classname' => 'event-listing-water-sports-cta-widget',
                'description' => esc_html__('Help to disply the important event link.', 'event-listing-water-sports'),
            );

            parent::__construct('event-listing-water-sports-cta-widget', esc_html__('Event Listing Call to Action', 'event-listing-water-sports'), $opts);
        }
        ...
        public function widget($args, $instance)
        {
            ...
            <div class="event-listing-water-sports-cta">
                <div class="event-listing-water-sports-cta-subtitle">
                    <?php echo esc_html($sub_title); ?>
                </div>
                <div class="event-listing-water-sports-cta-button">
        ...
        public function form($instance)
        {
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'event-listing-water-sports'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('sub_title')); ?>"><?php esc_html_e('Sub Title:', 'event-listing-water-sports'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('cta_btn_text')); ?>"><?php esc_html_e('Button Text:', 'event-listing-water-sports'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('btn_link')); ?>"><?php esc_html_e('Button Link:', 'event-listing-water-sports'); ?></label>
