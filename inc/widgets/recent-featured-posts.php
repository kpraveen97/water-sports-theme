...
if (!class_exists('Event_Listing_Featured_Post')) :
    ...
    class Event_Listing_Featured_Post extends WP_Widget
    {
        ...
        {
            $defaults = array(
                'title' => esc_html__('Recent Posts', 'event-listing-water-sports'),
                'cat' => 0,
                'post-number' => 3,
        ...
        {
            $opts = array(
                'classname' => 'event-listing-water-sports-featured-post',
                'description' => esc_html__('Display recent post with image on the front page widget area.', 'event-listing-water-sports'),
            );

            parent::__construct('event-listing-water-sports-featured-post', esc_html__('Event Listing Featured Post', 'event-listing-water-sports'), $opts);
        }
        ...
        public function form($instance)
        {
            ...
            <p class="custom-dropdown-posts">
                <label for="<?php echo esc_attr($this->get_field_name('cat')); ?>">
                    <strong><?php esc_html_e('Select Category: ', 'event-listing-water-sports'); ?></strong>
                </label>
                <?php
                $cat_args = array(
                    'orderby' => 'name',
                    ...
                    'show_option_all' => esc_html__('Show Recent Posts', 'event-listing-water-sports')
                );
            ...
            <p>
                <label
                        for="<?php echo esc_attr($this->get_field_id('post-number')); ?>"><?php esc_html_e('Number of Posts to Display:', 'event-listing-water-sports'); ?></label>
