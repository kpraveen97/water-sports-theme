...
function event_listing_ocdi_import_files() {
  return [
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/birthday/event-listing-water-sports-child-birthday-event.dat',
    ...
    [
      'import_file_name'             => 'water-sports',
      'categories'                   => [ 'Hybrid' ],
      'import_file_url'            => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/water-sports/water-sports-event-content.xml',
      'import_widget_file_url'     => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/water-sports/water-sports-event-demo-widgets.wie',
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/water-sports/event-listing-water-sports-child-water-sports-event.dat',
      'import_preview_image_url'     => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/water-sports/water-sports.png',
      'preview_url'                  => 'https://demo.wp-eventmanager.com/water-sports/',
    ],
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/conference/event-listing-water-sports-child-conference-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/dj-party/event-listing-water-sports-child-dj-party-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/festival/event-listing-water-sports-child-festival-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/learning/event-listing-water-sports-child-learning-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/marathon/event-listing-water-sports-child-marathon-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/theater/event-listing-water-sports-child-theater-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/virtual-event/event-listing-water-sports-child-virtual-event.dat',
	...
	[
      ...
      'import_customizer_file_url' => 'https://demo.wp-eventmanager.com/wp-content/uploads/dummy-data/wedding/event-listing-water-sports-child-wedding-event.dat',
