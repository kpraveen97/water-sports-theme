...
if (!function_exists('event_listing_dynamic_css')) :
    ...
    function event_listing_dynamic_css()
    {
        ...
        $event_listing_font_family = $event_listing_theme_options['event-listing-water-sports-font-family-url'];
        $event_listing_font_body_family = esc_attr($event_listing_google_fonts[$event_listing_font_family]);

        $event_listing_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-paragraph-font-size']);
        $event_listing_paragraph_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-paragraph-line-height']);
        $event_listing_paragraph_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-paragraph-letter-spacing']);
        $event_listing_paragraph_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-paragraph-font-weight']);

        /* H1 Font Options */
        $event_listing_h1_family = $event_listing_theme_options['event-listing-water-sports-h1-font-family-url'];
        $event_listing_h1_font_family = esc_attr($event_listing_google_fonts[$event_listing_h1_family]);
        $event_listing_h1_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h1-font-size']);
        $event_listing_h1_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h1-line-height']);
        $event_listing_h1_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h1-letter-spacing']);
        $event_listing_h1_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h1-font-weight']);

        /* H2 Font Options */
        $event_listing_h2_family = $event_listing_theme_options['event-listing-water-sports-h2-font-family-url'];
        $event_listing_h2_font_family = esc_attr($event_listing_google_fonts[$event_listing_h2_family]);
        $event_listing_h2_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h2-font-size']);
        $event_listing_h2_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h2-line-height']);
        $event_listing_h2_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h2-letter-spacing']);
        $event_listing_h2_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h2-font-weight']);

        /* H3 Font Options */
        $event_listing_h3_family = $event_listing_theme_options['event-listing-water-sports-h3-font-family-url'];
        $event_listing_h3_font_family = esc_attr($event_listing_google_fonts[$event_listing_h3_family]);
        $event_listing_h3_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h3-font-size']);
        $event_listing_h3_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h3-line-height']);
        $event_listing_h3_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h3-letter-spacing']);
        $event_listing_h3_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h3-font-weight']);

        /* H4 Font Options */
        $event_listing_h4_family = $event_listing_theme_options['event-listing-water-sports-h4-font-family-url'];
        $event_listing_h4_font_family = esc_attr($event_listing_google_fonts[$event_listing_h4_family]);
        $event_listing_h4_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h4-font-size']);
        $event_listing_h4_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h4-line-height']);
        $event_listing_h4_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h4-letter-spacing']);
        $event_listing_h4_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h4-font-weight']);

        /* H5 Font Options */
        $event_listing_h5_family = $event_listing_theme_options['event-listing-water-sports-h5-font-family-url'];
        $event_listing_h5_font_family = esc_attr($event_listing_google_fonts[$event_listing_h5_family]);
        $event_listing_h5_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h5-font-size']);
        $event_listing_h5_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h5-line-height']);
        $event_listing_h5_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h5-letter-spacing']);
        $event_listing_h5_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h5-font-weight']);

        /* H6 Font Options */
        $event_listing_h6_family = $event_listing_theme_options['event-listing-water-sports-h6-font-family-url'];
        $event_listing_h6_font_family = esc_attr($event_listing_google_fonts[$event_listing_h6_family]);
        $event_listing_h6_font_size = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h6-font-size']);
        $event_listing_h6_line_height = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h6-line-height']);
        $event_listing_h6_letter_spacing = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h6-letter-spacing']);
        $event_listing_h6_font_weight = esc_attr($event_listing_theme_options['event-listing-water-sports-font-h6-font-weight']);
        ...
        if (!empty($event_listing_primary_color)) {
            $custom_css .= "
            :root{
                --wpem-primary-color:" . $event_listing_primary_color . ";
            }";
        }
        ...
        if (!empty($event_listing_secondary_color)) {
            $custom_css .= "
            :root{
                --wpem-secondary-color:" . $event_listing_secondary_color . ";
            }";
        }
        ...
        wp_add_inline_style('event-listing-water-sports-style', $custom_css);
    }
endif;
