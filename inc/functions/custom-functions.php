...
if (!function_exists('event_listing_recommended_plugins')) :
    ...
    function event_listing_recommended_plugins()
    {
        ...
        $plugins = array(
            array(
                'name' => __('WP Event Manager', 'event-listing-water-sports'),
...
if (!function_exists('event_listing_custom_class')) :
    function event_listing_custom_class($classes)
    {
        ...
        $layout = $event_listing_theme_options['event-listing-water-sports-full-boxed'];
        $classes[] = esc_attr($event_listing_theme_options['event-listing-water-sports-site-sidebar']);
        $classes[] = esc_attr($event_listing_theme_options['event-listing-water-sports-mobile-sidebar']);
        if ($layout == 'boxed') {
...
if (!function_exists('event_listing_sidebar')) :
    ...
    {
        global $event_listing_theme_options;
        $sidebar = $event_listing_theme_options['event-listing-water-sports-site-sidebar'];
